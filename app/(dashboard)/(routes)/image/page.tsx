  ...
  return (
    <div>
      <Heading
        ...
        description="Get an image from words"
        icon={ImageIcon}
                ...
                <FormItem className="col-span-12 lg:col-span-6">
                  <FormControl className="m-0 p-0">
                    <Input
                      ...
                      disabled={isLoading}
                      placeholder="Picture of Muhammed Ali playing basketball wearing jordans"
                      {...field}
                    />
      ...
      <div className="space-y-4 mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mt-8">{images.map((src) => (
