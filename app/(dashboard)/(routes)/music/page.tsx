...
const MusicPage = () => {
  ...
  return (
    <div>
      <Heading
        title="Music"
        description="Ask anything and turn it into music"
        icon={Music}
              ...
              render={({ field }) => (
                <FormItem className="col-span-12 lg:col-span-10">
                  <FormControl className="m-0 p-0">
                    <Input className="border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent" disabled={isLoading} placeholder="riff on the piano" {...field} />
